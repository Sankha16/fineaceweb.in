(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["fineace\\\\.godaddysites\\\\.com(?:/.*)?/ola/services/.*","fineace\\\\.godaddysites\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://77157f2f-db88-4a04-96f7-5945de5af2d3\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["fineace\\\\.godaddysites\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/77157f2f-db88-4a04-96f7-5945de5af2d3/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/77157f2f-db88-4a04-96f7-5945de5af2d3/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/about-us","/","/contact-us"]').map((e => ({
                url: e,
                revision: "1667557587949"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("fineace.godaddysites.com-"))).map((e => caches.delete(e))))
            })))
